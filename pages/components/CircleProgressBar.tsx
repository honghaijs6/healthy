const CirleProgressBar = ({ percentage = 0, title = "", color = "#fff" }) => {
    return (
        <div className="circle-progress">
            <svg viewBox="-1 -1 34 34">
                <circle cx="16" cy="16" r="15.9155" className="progress-bar__background" />
                <circle cx="16" cy="16" r="15.9155" stroke={color} className="progress-bar__progress js-progress-bar" style={{ strokeDashoffset: 100 - percentage }} />
            </svg>
